...
import { FaCartFlatbedSuitcase, FaShop, FaUsers } from "react-icons/fa6";
...
const menuGroups = [
  {
    ...
    menuItems: [
      ...
      },
      {
        ...
        route: "#",
        children: [
          { label: "List", route: "/admin/user/list" },
          { label: "Add", route: "/admin/user/add" },
        ],
      },
      {
        ...
        route: "#",
        children: [
          { label: "Category", route: "/admin/category/list" },
          { label: "Brand", route: "/admin/brand/list" },
        ],
      },
      {
        icon: <GrGallery />,
        ...
        route: "#",
        children: [
          { label: "List", route: "/admin/gallery/list" },
          { label: "Add", route: "/admin/gallery/add" },
        ],
      },
      {
        icon: <FaShop />,
        label: "Shop Types",
        route: "/admin/shop-types/list",
      },

      {
        ...
        route: "#",
        children: [
          { label: "List", route: "/admin/project/list" },
          { label: "Add", route: "/admin/project/add" },
        ],
      },
    ],
  },
...
const Sidebar = ({ sidebarOpen, setSidebarOpen }: SidebarProps) => {
  ...
  return (
    <ClickOutside onClick={() => setSidebarOpen(false)}>
      <aside
        className={`bg-base-100 fixed top-0 left-0 z-[999] flex h-screen w-72 flex-col overflow-y-hidden border-r border-r-cyan-50/10 duration-300 ease-linear lg:translate-x-0 ${
        ...
        <div className="flex items-center justify-center gap-2 px-6 py-5 lg:py-6">
          ...
          <div className="hidden lg:block">
            <Link href="/" className="">
              ...
              {/* <p className="dark:text-primary">{`Wheels Drift`}</p> */}
            </Link>
          </div>
        ...
        <div className="no-scrollbar flex flex-col overflow-y-auto duration-300 ease-linear">
          ...
          <nav className="mt-5 px-2 py-4 lg:mt-9 lg:px-3">
            {menuGroups.map((group, groupIndex) => (
              <div key={groupIndex}>
                <h3 className="text-base-content mb-4 ml-4 font-semibold">{group.name}</h3>
