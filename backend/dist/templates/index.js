...
//   "utf-8"
// );
const OTPVerrficationTemplate = fs.readFileSync(path.join(__dirname, "../templates/OTPVerrfication.template.ejs"), // Adjust this path as necessary
"utf-8");
const ResetPasswordLinkTemplate = fs.readFileSync(path.join(__dirname, "../templates/ResetPasswordLink.template.ejs"), // Adjust this path as necessary
"utf-8");
export { 
//  sellerOnboardingTemplate, sellerOnboardingStatusTemplate,
OTPVerrficationTemplate, ResetPasswordLinkTemplate, };
