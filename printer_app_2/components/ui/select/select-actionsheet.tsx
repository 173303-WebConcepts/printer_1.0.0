...
const actionsheetItemStyle = tva({
  base: 'w-full flex-row items-center p-3 rounded-sm data-[disabled=true]:opacity-40 data-[disabled=true]:web:pointer-events-auto data-[disabled=true]:web:cursor-not-allowed hover:bg-primary active:bg-none data-[focus=true]:bg-background-100 web:data-[focus-visible=true]:bg-background-100 data-[checked=true]:bg-primary',
});

const actionsheetItemTextStyle = tva({
  base: 'text-base-content-70 font-grotes tracking-md text-left mx-2',
  variants: {
    isTruncated: {
      true: '',
    },
