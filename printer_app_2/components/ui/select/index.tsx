...
const selectInputStyle = tva({
  base: 'px-3 font-grotes placeholder:text-base-content-70 web:w-full h-full text-base-content-70 pointer-events-none web:outline-none ios:leading-[0px] py-0',
  parentVariants: {
    size: {
      xl: 'text-xl',
      lg: 'text-lg',
