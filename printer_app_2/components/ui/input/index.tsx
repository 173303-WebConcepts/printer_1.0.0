...
const inputStyle = tva({
  base: 'border-background-300 flex-row overflow-hidden content-center data-[hover=true]:border-outline-400 data-[focus=true]:border-base-200 data-[focus=true]:hover:border-base-200 data-[disabled=true]:opacity-40 data-[disabled=true]:hover:border-background-300 items-center',
...
const inputFieldStyle = tva({
  base: 'flex-1 text-base-content-70 py-0 font-grotes px-3 placeholder:text-base-content-70 h-full ios:leading-[0px] web:cursor-text web:data-[disabled=true]:cursor-not-allowed',
...
>(function InputField({ className, ...props }, ref) {
  ...
  return (
    <UIInput.Input
      ref={ref}
      {...props}
      selectionColor="#FD680D" // 👈 this controls the blinking caret color
